...
<div class="container">
  <form action="/action_page.php">
    <div class="row">
      ...
      <div class="col">
        <a href="javascript:login('naver')" class="fb btn">
          <i class="fa fa-facebook fa-fw"></i> Login With Naver
         </a>
        <a href="javascript:login('kakao')" class="twitter btn">
          <i class="fa fa-twitter fa-fw"></i> Login with Kakao
        </a>
