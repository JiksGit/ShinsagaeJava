...
//web.xml 을 사용하지 않고, 어노테이션 기반으로 서블릿을 매핑하는 방법
...
public class LoginServlet  extends HttpServlet{
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//DB연동하는 대신, 조건문으로 인증을 처리하자 
		if(id.equals(username) && pwd.equals(password)) { //회원이라면...
			...
			//응답 본문의 데이터 형식을 지정하여, 브라우저가 본문을 json 으로 해석하도록 지시
			...
			*/
			//Gson 으로 더 편하게 처리해보자 
			//java 클래스를 정의해도 되지만, 귀찮을 경우 Map 을 json 문자열로 변환시키자
