...
public class RegistServlet extends HttpServlet{
	...
	// 이 요청은 유저가 보게될 디자인과 관련없으므로, 이 요청을 처리할 기술을 Servlet으로 선택함
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String title = request.getParameter("title"); //html에 지정한 name명
		...
		try {
			...
			// 응답 객체인 Response에 들어있는 출력스트림에 누적되어 있는 문자열을 이용하여, HTML 컨텐츠 생성
			// 하기 때문에..
			out.print("<script>");
