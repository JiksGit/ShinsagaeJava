...
public class ProductPage extends Page{
	...
	Image[] imgArray; // 유저가 선택한 파일 정보의 이미지를 가진 배열
	File[] files;
...
//					System.out.println(e);	
	...
	public void preview() {
		...
		if(files.length > 6) {
			...
			imgArray = new Image[files.length]; // 파일의 수에 맞게 이미지 준비
	...
	public void getSubCategory(TopCategory topCategory) {
		...
		dummy.setSub_name("하위 카테고리를 선택해주세요");
	...
	public void upload() {
		// 시각적 효과를 위해 각, 이미지의 업로드 진행률을 보여주자, 새 창으로
