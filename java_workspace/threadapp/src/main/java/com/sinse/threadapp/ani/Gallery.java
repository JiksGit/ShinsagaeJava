...
public class Gallery extends JFrame{
	...
	public Gallery() {
		...
		thread.start(); // gameLoop()와 같이 계속 수행
...
//						System.out.println(i +"번째 썸네일 클릭");
						currentIndex = i;
						p_center.repaint();
...
//						move();
	...
	// 포인터가 목적지에 한번에 도달하게 하지 말고, 감속도 공식을 적용하여 움직이게
	public void move() {
		// y값은 = 기존 y 값 + a*(목적y지점 - 현재y지점)
		y = y + a*(targetY - y);
	}
