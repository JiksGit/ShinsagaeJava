...
//        }
        ...
        // 이 방법은 권장되지 않음
        // 따라서 지금부터, Open API의 String 결과물을 자바의 클래스로 매핑시키되, jacson을 이용해서 자동화 시킴
        // 클라이언트에게 응답 정보로 사용할 수 있음 뿐 아니라, 객체화 되어 있기 때문에 서버에서도
        // 활용할 수 있다.
    ...
    /*
     HttpURLConnection은 동작은 하지만, 최신의 방식은 아님
     코드가 복잡하다
     */
